...
- `quest31-m014.kif` 〜 `quest31-m030.kif` — Shogi Quest の対人局
  ...
  `bin/rank_dump` で生成）の常設シナリオ化で、m014〜m030 は
  14〜30手目ぶん（2026-08-02 作成。doc の続きが書かれたら同名規則
  `quest31-mNNN` で追加していく）。先手番・後手番が交互なので batch では
