...
// 注意: 24次元目（my_foul_count_last_turn）は手編集のゼロ重みパディング
// （mean=0, std=1, W1列=0）。24次元データで再学習・再生成するまでは
// 出力がv10（23次元）と厳密に一致する
pub const OPP_MOVE_NN_MEAN: [f64; 24] = [2.35620961e-01, 2.96360929e-03, 3.73274530e-03, 6.66909873e-01, 2.37797350e-01, 2.33220547e-01, 3.45509611e-02, 9.08421911e-03, 2.97663733e-02, 7.64817894e-02, 1.10504240e-01, 1.53451845e-01, 1.21668890e-01, 1.38100132e-01, 1.42608285e-01, 1.45957202e-01, 1.57402709e-01, 1.37834400e-01, 1.08427867e-01, 1.35118440e-01, 3.03539280e-02, 4.55895007e-01, 1.77477017e-01, 0.00000000e+00];
pub const OPP_MOVE_NN_STD: [f64; 24] = [7.13434398e-01, 5.42815216e-02, 6.08693138e-02, 4.74458277e-01, 4.30749178e-01, 4.25494701e-01, 1.80915147e-01, 9.44889858e-02, 1.67984039e-01, 2.63105720e-01, 3.16384524e-01, 3.66432369e-01, 4.06966567e-01, 3.45470637e-01, 3.51286083e-01, 3.52810502e-01, 3.68679315e-01, 3.45605552e-01, 3.14655155e-01, 3.42999905e-01, 1.69433326e-01, 8.62318218e-01, 3.82403940e-01, 1.00000000e+00];
pub const OPP_MOVE_NN_W1: [[f64; 24]; 16] = [
    [1.68057752e+00, -2.06585735e-01, -3.46413314e-01, -6.75095618e-02, -3.61814946e-01, 4.89170760e-01, 9.97593850e-02, -1.72861964e-02, -4.67493653e-01, 5.40614910e-02, -6.23640001e-01, 9.09997746e-02, -1.13709915e+00, 1.64650500e-01, 6.59997523e-01, -1.56713828e-01, -1.63836032e-01, 7.36852586e-01, -9.41342890e-01, -7.24782586e-01, 1.33954614e-01, -5.00219464e-01, -1.13039744e+00, 0.00000000e+00],
    [6.29862189e-01, 1.18328311e-01, 7.84092322e-02, -6.44954592e-02, -8.14876676e-01, -1.59662831e+00, -2.90393442e-01, 2.17357706e-02, 3.23224455e-01, -3.78575444e-01, -2.47903258e-01, -3.46646100e-01, -1.28789041e-02, -4.70404804e-01, 1.86269268e-01, 8.09303343e-01, -2.85762221e-01, 1.11681364e-01, -2.25908905e-01, 4.24010128e-01, -3.17685485e-01, -1.55349863e+00, -1.59390718e-01, 0.00000000e+00],
    [-3.32267806e-02, -2.34113768e-01, -6.11816011e-02, -6.47719383e-01, 1.22894786e-01, 1.18594038e+00, -5.31974852e-01, 1.35534778e-02, 2.68981811e-02, -8.38981986e-01, -6.15009904e-01, -7.83992052e-01, -1.03753197e+00, -1.65791973e-01, -8.44526589e-01, 6.06956601e-01, 6.04917370e-02, -3.78165752e-01, 3.14076304e-01, 6.15237653e-01, 1.77716106e-01, -9.44229245e-01, 1.04542387e+00, 0.00000000e+00],
    [7.06437409e-01, -4.29021567e-01, -3.04436743e-01, -6.15958691e-01, -2.01275479e-02, 1.19325817e+00, 3.23976129e-01, 3.02250870e-02, -2.15725377e-01, -1.35047510e-01, -1.84587702e-01, -1.29711151e-01, 1.39636648e+00, 5.25133967e-01, -3.77416462e-01, -5.60170710e-01, -7.53012598e-01, 1.20027270e-02, 1.03113495e-01, 7.90625632e-01, -1.54382959e-01, -2.11276293e+00, 2.62570381e-01, 0.00000000e+00],
...
/// `exp(logit)` として使う
pub fn opp_move_nn_forward(features: &[f64; 24]) -> f64 {
    let mut x = [0.0f64; 24];
    for i in 0..24 {
...
mod tests {
    ...
    fn matches_numpy_cross_check() {
        ...
        bishop_probe[23] = 2.0; // my_foul_count_last_turn（ゼロ重みパディング中は出力に影響しない）
        let cases: [([f64; 24], f64); 3] = [
            ([0.0; 24], -0.5839394210402274),
            (pawn_push, -0.6525624719026513),
            (bishop_probe, -1.2984706004133495),
        ];
